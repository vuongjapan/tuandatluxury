    ...
    >
      ...
      <div className="section-container">
        <div className="flex flex-col md:flex-row items-stretch min-h-[200px] md:min-h-[140px] md:h-[140px]">
          ...
          {/* MIDDLE - Content */}
          <div className="flex-1 md:w-1/2 flex flex-col justify-center py-4 md:py-0">
            <h3
          ...
          {/* RIGHT - CTA */}
          <div className="md:w-1/4 flex md:flex-col items-center justify-center gap-3 py-4 md:py-0">
            <span
